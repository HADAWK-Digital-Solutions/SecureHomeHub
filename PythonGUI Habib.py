...
class App:
    def __init__(self, root):
        ...
        # Add an instance variable to keep track of the current page ID
    ...
    def create_alerts_page(self):
        ...
        for item in ["ALERT: 2023-10-11 6:20 PM", "ALERT: 2023-10-11 6:29 PM", "ALERT: 2023-10-12 6:40 PM",
                     "ALERT: 2023-10-13 8:20 PM"]:
        ...
        button = tk.Button(sub_frame, text=f"Intrusion Detection",
                           command=lambda: call(['python', '-i', 'intrusion_detect_v2.py']))
    ...
    def compare_files(self):
        ...
        if os.path.exists(file_path):
            ...
            iot_devices_script_output = subprocess.check_output(['python3', iot_devices_script_path],
    ...
    def create_devices_page(self):
        ...
        button.grid(row=0, column=2, padx=10)
        button = tk.Button(sub_frame, text=f"Scan for Intrusion on Devices",
                           command=lambda: call(['python3', '-i', 'intrusion_detect_v2.py']))
        button.grid(row=0, column=3, padx=10)
    ...
    def create_scans_page(self):
        ...
        # Insert Scans, [AUTO] is used when ti's a Nightly or automatic scan specified from Scan Times.
        for item in ["Scan 2023-10-12 11:39 PM", "Scan 2023-10-13 11:20 PM", "Scan 2023-10-14 10:20 PM",
                     "[AUTO] Scan 2023-10-15 9:30 PM"]:
            listbox.insert(tk.END, item)
